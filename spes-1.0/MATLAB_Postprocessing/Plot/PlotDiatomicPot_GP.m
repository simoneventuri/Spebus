function PlotDiatomicPot_GP(iFigure, G_MEAN, G_SD, Lambda, re, Exp1, Exp2, Exp3, Exp4, l1, l2, Amp, SigmaNoise)
  ...
  [EPred]        = ComputeOutput_GP(RTest, G_MEAN, G_SD, Lambda, re, Exp1, Exp2, Exp3, Exp4, l1, l2, Amp, SigmaNoise);
  RTest          = [1.d2,1.d2,1.d2];
  [EPredInf]     = ComputeOutput_GP(RTest, G_MEAN, G_SD, Lambda, re, Exp1, Exp2, Exp3, Exp4, l1, l2, Amp, SigmaNoise);
  if strcmp(System,'N3')
