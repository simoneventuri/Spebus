function ComputePESDerivatives_GP(AngVec, G_MEAN, G_SD, ModPip, re, Obs_Idx_Pts, Amp, Alpha, LKern)
  ...
  for Ang = AngVec
    ...
    for i1 = 1:NPoints1
      ...
      for i3 = 1:NPoints3
        ...
        E(i1,i3)   = ComputeOutput_GP(R, G_MEAN, G_SD, ModPip, re, Obs_Idx_Pts, Amp, Alpha, LKern);

        RTemp      = repmat(R,9,1);
        RTemp(:,1) = R1 + h1 .* [-4,-3,-2,-1,0,1,2,3,4]';
        ETemp      = ComputeOutput_GP(RTemp, G_MEAN, G_SD, ModPip, re, Obs_Idx_Pts, Amp, Alpha, LKern);
