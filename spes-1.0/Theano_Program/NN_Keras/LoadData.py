...
def load_data(NNInput):
    ...
    def shared_dataset(DataRGY, borrow=True):
        ...
        """
        RData, yData1, yData2, yData3  = DataRGY
    ...
    SetValid = (RSetValid, ySetValid, ySetValidDiat, ySetValidTriat)

    RSetTrain, ySetTrain, ySetTrainDiat, ySetTrainTriat = shared_dataset(SetTrain)
    RSetValid, ySetValid, ySetValidDiat, ySetValidTriat = shared_dataset(SetValid)
