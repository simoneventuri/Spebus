...
def construct_model(NNInput, Input, y, InitW, Initb):
    ...
    with pymc3.Model() as model:
        ...
        Lambda = pymc3.Uniform('Lambda', lower=0.0, upper=2.0, shape=(1,1), testval=1.0)
        re     = pymc3.Uniform('re',     lower=0.0, upper=1.5, shape=(1,1), testval=1.0)
