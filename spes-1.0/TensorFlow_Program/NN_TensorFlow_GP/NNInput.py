...
class NNInput(object):
    ...
    PathToDataFldr         = PathToSPES + '/Data_PES/N3/NASA_Kolb/'
    PathToOutputFldr       = PathToSPES + '/../Output_MAC/Determ/N3/'
    PathToWeightFldr       = PathToSPES + '/../Output_MAC/Determ/N3/'
    # PathToSPES             = '/home/venturi/WORKSPACE/SPES/spes/'
    # PathToDataFldr         = PathToSPES + '/Data_PES/N3/NASA_Kolb/'
    # PathToOutputFldr       = PathToSPES + '/../Output_ENTROPY/DetTF/N3/'
    # PathToWeightFldr       = PathToSPES + '/../results/DetTF_1/N3/'
