...
class NNInput(object):
    ...
    # PathToDataFldr         = PathToSPES + '/Data_PES/CO2/Grid_Kolb/PES_1/'
    # PathToOutputFldr       = PathToSPES + '/../Output_MAC/Determ/CO2/'
    # PathToWeightFldr       = PathToSPES + '/../Results/NN_PIP/CO2/Test1/'
    PathToSPES             = '/home/venturi/WORKSPACE/SPES/spes/'
    PathToDataFldr         = PathToSPES + '/Data_PES/CO2/Grid_Kolb/PES_1/'
    PathToOutputFldr       = PathToSPES + '/../Output_ENTROPY/DetTF/CO2/'
    PathToWeightFldr       = PathToSPES + '/../results/DetTF_1/CO2/'
