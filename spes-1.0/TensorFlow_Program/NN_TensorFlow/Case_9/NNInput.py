...
class NNInput(object):
    ...
    if (Model=='ModPIP'):
        ...
        BiasesFlg              = True
        PathToOutputFldr       = PathToSPES + '/../Output_TESTS_Det/Case_9/TensorFlow/'
        PathToWeightFldr       = PathToSPES + '/../Output_TESTS_Det/Case_9/TensorFlow/'
        CheckpointFilePath     = PathToSPES + '/../Output_TESTS_Det/Training_9/cp.ckpt'    
        CheckpointFldr         = PathToSPES + '/../Output_TESTS_Det/Training_9/'    
