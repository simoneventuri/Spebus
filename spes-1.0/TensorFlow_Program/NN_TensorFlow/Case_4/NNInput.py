...
class NNInput(object):
    ...
    if (Model=='ModPIP'):
        ...
        BiasesFlg              = True
        PathToOutputFldr       = PathToSPES + '/../Output_TESTS_Det/Case_4/TensorFlow/'
        PathToWeightFldr       = PathToSPES + '/../Output_TESTS_Det/Case_4/TensorFlow/'
        CheckpointFilePath     = PathToSPES + '/../Output_TESTS_Det/Training_4/cp.ckpt'    
        CheckpointFldr         = PathToSPES + '/../Output_TESTS_Det/Training_4/'    
