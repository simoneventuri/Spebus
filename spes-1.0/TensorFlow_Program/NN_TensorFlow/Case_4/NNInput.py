...
class NNInput(object):
    ...
    if (Model=='ModPIP'):
        ...
        BiasesFlg              = True
        PathToOutputFldr       = PathToSPES + '/../Output_TESTS/Case_4/TensorFlow/'
        PathToWeightFldr       = PathToSPES + '/../Output_TESTS/Case_4/TensorFlow/'
        CheckpointFilePath     = PathToSPES + '/../Output_TESTS/Training_4/cp.ckpt'    
        CheckpointFldr         = PathToSPES + '/../Output_TESTS/Training_4/'    
