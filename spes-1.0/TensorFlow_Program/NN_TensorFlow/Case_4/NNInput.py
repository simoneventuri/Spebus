...
class NNInput(object):
    ...
    if (Model=='ModPIP'):
        ...
        BiasesFlg              = True
        PathToOutputFldr       = PathToSPES + '/../Output_FINAL/Case_4/TensorFlow/'
        PathToWeightFldr       = PathToSPES + '/../Output_FINAL/Case_4/TensorFlow/'
        CheckpointFilePath     = PathToSPES + '/../Output_FINAL/Training_4/cp.ckpt'    
        CheckpointFldr         = PathToSPES + '/../Output_FINAL/Training_4/'    
