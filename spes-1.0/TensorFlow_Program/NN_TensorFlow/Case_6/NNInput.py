...
class NNInput(object):
    ...
    if (Model=='ModPIP'):
        ...
        BiasesFlg              = True
        PathToOutputFldr       = PathToSPES + '/../Output_TESTS/Case_6/TensorFlow/'
        PathToWeightFldr       = PathToSPES + '/../Output_TESTS/Case_6/TensorFlow/'
        CheckpointFilePath     = PathToSPES + '/../Output_TESTS/Training_6/cp.ckpt'    
        CheckpointFldr         = PathToSPES + '/../Output_TESTS/Training_6/'    
