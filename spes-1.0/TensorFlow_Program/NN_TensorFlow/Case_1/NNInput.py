...
class NNInput(object):
    ...
    if (Model=='ModPIP'):
        ...
        BiasesFlg              = True
        PathToOutputFldr       = PathToSPES + '/../Output_FINAL/Case_1/TensorFlow/'
        PathToWeightFldr       = PathToSPES + '/../Output_FINAL/Case_1/TensorFlow/'
        CheckpointFilePath     = PathToSPES + '/../Output_FINAL/Training_1/cp.ckpt'    
        CheckpointFldr         = PathToSPES + '/../Output_FINAL/Training_1/'    
