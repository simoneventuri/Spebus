...
class NNInput(object):
    ...
    if (Model=='ModPIP'):
        ...
        BiasesFlg              = True
        PathToOutputFldr       = PathToSPES + '/../Output_TESTS/Case_5/TensorFlow/'
        PathToWeightFldr       = PathToSPES + '/../Output_TESTS/Case_5/TensorFlow/'
        CheckpointFilePath     = PathToSPES + '/../Output_TESTS/Training_5/cp.ckpt'    
        CheckpointFldr         = PathToSPES + '/../Output_TESTS/Training_5/'    
