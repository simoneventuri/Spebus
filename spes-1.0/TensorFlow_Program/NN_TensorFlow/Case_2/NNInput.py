...
class NNInput(object):
    ...
    if (Model=='ModPIP'):
        ...
        BiasesFlg              = True
        PathToOutputFldr       = PathToSPES + '/../Output_FINAL/Case_2/TensorFlow/'
        PathToWeightFldr       = PathToSPES + '/../Output_FINAL/Case_2/TensorFlow/'
        CheckpointFilePath     = PathToSPES + '/../Output_FINAL/Training_2/cp.ckpt'    
        CheckpointFldr         = PathToSPES + '/../Output_FINAL/Training_2/'    
