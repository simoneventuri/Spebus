...
class NNInput(object):
    ...
    if (Model=='ModPIP'):
        ...
        BiasesFlg              = True
        PathToOutputFldr       = PathToSPES + '/../Output_TESTS/Case_2/TensorFlow/'
        PathToWeightFldr       = PathToSPES + '/../Output_TESTS/Case_2/TensorFlow/'
        CheckpointFilePath     = PathToSPES + '/../Output_TESTS/Training_2/cp.ckpt'    
        CheckpointFldr         = PathToSPES + '/../Output_TESTS/Training_2/'    
