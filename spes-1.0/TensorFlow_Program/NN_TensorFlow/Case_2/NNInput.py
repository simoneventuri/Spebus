...
class NNInput(object):
    ...
    if (Model=='ModPIP'):
        ...
        BiasesFlg              = True
        PathToOutputFldr       = PathToSPES + '/../Output_TESTS_Det/Case_2/TensorFlow/'
        PathToWeightFldr       = PathToSPES + '/../Output_TESTS_Det/Case_2/TensorFlow/'
        CheckpointFilePath     = PathToSPES + '/../Output_TESTS_Det/Training_2/cp.ckpt'    
        CheckpointFldr         = PathToSPES + '/../Output_TESTS_Det/Training_2/'    
