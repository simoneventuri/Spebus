...
class NNInput(object):
    ...
    if (Model=='ModPIP'):
        ...
        BiasesFlg              = True
        PathToOutputFldr       = PathToSPES + '/../Output_FINAL/PES1/TensorFlow/'
        PathToWeightFldr       = PathToSPES + '/../Output_FINAL/PES1/TensorFlow/'
        CheckpointFilePath     = PathToSPES + '/../Output_FINAL/Training_PES1/cp.ckpt'    
        CheckpointFldr         = PathToSPES + '/../Output_FINAL/Training_PES1/'    
