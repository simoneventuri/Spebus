...
filename = '/Users/sventuri/WORKSPACE/SPES/spes/Data_PES/N3/NASA_AbInitio_David_OldDiatPot/ACPF_David_NoOutLayer.csv'
delimiter = ',';
startRow = 2;
...
filename = '/Users/sventuri/WORKSPACE/SPES/spes/Data_PES/N3/NASA_AbInitio_David_OldDiatPot/MRCI_Q_David.csv';
delimiter = ',';
startRow = 2;
formatSpec = '%s%s%s%s%s%[^\n\r]';
fileID = fopen(filename,'r');
