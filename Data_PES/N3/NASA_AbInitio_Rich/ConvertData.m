...
filename = '/Users/sventuri/WORKSPACE/SPES/spes/Data_PES/N3/NASA_AbInitio_Rich/ACPF_Rich.csv';
delimiter = ',';
startRow = 2;
...
for i=1:size(R1,1)
  ...
  for iR=1:3
    ...
    VDiatNew = VDiat + N2_LeRoy(R1(i,iR));
  end
...
filename = '/Users/sventuri/WORKSPACE/SPES/spes/Data_PES/N3/NASA_AbInitio_Rich/MRCI_Q_Rich.csv';
delimiter = ',';
startRow = 2;
formatSpec = '%s%s%s%s%s%[^\n\r]';
fileID = fopen(filename,'r');
...
for i=1:size(R2,1)
  ...
  for iR=1:3
    ...
    VDiatNew = VDiat + N2_LeRoy(R2(i,iR));
  end
